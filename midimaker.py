...
class MidiController:
    ...
    def __init__(self):
        ...
        if available_ports:
            ...
            self.midi_out.open_virtual_port("Virtual MIDI Port")
    ...
    def send_midi_note(self, note: int, note_on: bool):
        ...
        velocity = self.calculate_velocity(self.last_note, self.last_note) if note_on else 0
...
def read_serial_data(port: str, midi_controller: MidiController, baudrate: int = 9600, timeout: int = 1):
